...
<html lang="en">
  <head>
    ...
    <title>Control de Asistencia Arquitectura | </title>
  ...
  <body class="nav-md">
    <div class="container body">
      <div class="main_container">
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.html" class="site_title"><i class="fa fa-paw"></i> <span>Bienvenido/a</span></a>
            </div>
        ...
        <!-- footer content -->
        <footer style="top:75%; position: relative;">
